...
class LocalFrontendApplication {
    ...
    waitUntilExiting() {
        if (this._exitPromise == null) {
            return Promise.resolve('No currently online.');
        }
    ...
    async_build_session (websocket) {
        if (this._sessionBuildPromise != null) {
            throw "Cannot build a session, because another one is currently building.";
        }
        ...
        this._sessionBuildPromise.then(function () {
            this._sessionBuildPromise = null;
